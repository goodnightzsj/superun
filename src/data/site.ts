...
export const templates: TemplateRecord[] = [
  {
    slug: 'snapshot-sales-incentive-platform',
    title: '薪擎 - 业绩提成绩效管理平台',
    description: '面向中型企业的销售绩效管理平台，三端联动管理提成规则、核算审批与团队人效。',
    category: '管理类应用',
    tag: '销售绩效',
    badge: '复刻',
    previewTheme: 'light',
  ...
  {
    slug: 'snapshot-performance-star',
    title: '绩效星',
    description: '面向中大型企业的一站式绩效管理平台，覆盖目标制定、过程跟踪到绩效评估的完整闭环并支持三端协同与移动适配。',
    category: '管理类应用',
    tag: '绩效平台',
    badge: '复刻',
    previewTheme: 'light',
  ...
  {
    slug: 'snapshot-recruitment-flow',
    title: '招聘流程管理',
    description: '招聘流程管理：HR面试、人才评估与入职流程工作台。',
    category: '管理类应用',
    tag: '招聘流程',
    badge: '复刻',
    previewTheme: 'light',
    heroMetric: 'HR 面试工作台',
    detailMetric: '评估与入职联动',
  },
  {
  ...
  {
    slug: 'snapshot-sales-visit-assistant',
    title: '销售拜访助手',
    description: '面向外勤销售的拜访与客户管理助手，支持本地运行与智能日报，含消息通知与主题定制。',
    category: '管理类应用',
    tag: '销售助手',
    badge: '复刻',
    previewTheme: 'light',
  ...
  {
    slug: 'snapshot-smart-recruiting-platform',
    title: '智能招聘管理平台',
    description: '智聘智能招聘管理平台，简化流程并支持 AI 岗位描述生成。',
    category: '管理类应用',
    tag: '招聘平台',
    badge: '复刻',
    previewTheme: 'light',
    heroMetric: '智能招聘',
    detailMetric: '岗位生成与流程协同',
  },
  {
  ...
  {
    slug: 'snapshot-customer-management-system',
    title: '客户管理系统',
    description: '面向销售与客户成功团队的 CRM 演示平台，含线索、续约与 AI 洞察。',
    category: '管理类应用',
    tag: 'CRM 平台',
    badge: '复刻',
    previewTheme: 'light',
    heroMetric: 'CRM 演示平台',
    detailMetric: '线索与续约洞察',
  },
  {
